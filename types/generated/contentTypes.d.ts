...
export interface ApiLiveDarshanLiveDarshan extends Struct.CollectionTypeSchema {
  collectionName: 'live_darshans';
  info: {
    displayName: 'Live Darshan';
    pluralName: 'live-darshans';
    singularName: 'live-darshan';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    LiveVideoUrl: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::live-darshan.live-darshan'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    TempleName: Schema.Attribute.String;
...
export interface ApiTemplecollectionTemplecollection
  ...
  info: {
    displayName: 'Templecollection';
    pluralName: 'templecollections';
    singularName: 'templecollection';
  };
  options: {
    draftAndPublish: true;
  };
